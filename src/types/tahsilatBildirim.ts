...
export const BILDIRIM_IS_DURUM_LABEL: Record<BildirimIsDurumu, string> = {
  ...
  PLANLANDI: 'Gönderilmeyi bekliyor',

  KUYRUKTA: 'Gönderilmeyi bekliyor',

  SIMULASYON_TAMAMLANDI: 'WhatsApp açıldı',
...
export function readBildirimOzetCounts(ozet: TahsilatBildirimOzetDto | undefined): {
  ...
  return {
    ...
    gonderilmeyiBekleyen: ozet?.gonderilmeyiBekleyen ?? ozet?.yaklasan ?? ozet?.planlananlar ?? 0,
